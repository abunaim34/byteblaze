        ...
        <div className="hero -mt-16 ">
            <div className="hero-content text-center">
                <div className="max-w-lg">
                    <h1 className="text-5xl font-bold">Welcome to <span className="bg-gradient-to-r from-primary via-blue-500 bg-300% to-secondary text-transparent bg-clip-text animate-gradient">ByteBlaze</span></h1>
