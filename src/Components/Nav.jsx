...
const Nav = () => {
    ...
    return (
        <div className="navbar px-8 bg-base-100 shadow-lg fixed z-10">
            <div className="flex-1">
                <Link to='/' className="btn btn-ghost gap-0 text-2xl text-secondary normal-case ">Byte<span className="text-primary">Blaze</span></Link>
            </div>
            <div className="flex-none">
                <ul className="menu hidden sm:flex menu-horizontal px-1 gap-5 font-bold">
